            ...
            <div class="col-md-8 col-sm-12">
              <span class="icp-container-desktop">
                <div class="navFooterLine">
                  <a href="#" class="icp-button text-decoration-none">
                    <div
                      class="icp-nav-globe-img-2 icp-button-globe-2 icp-nav-globe-curr-fix"
                    >
                      ​
                    </div>
                    <span class="icp-color-base ps-2">English</span>
                    <span class="nav-arrow icp-up-down-arrow"></span>
                  </a>
                  <a href="#" class="icp-button text-decoration-none">
                    <span class="icp-currency-symbol">$</span>
                    <span class="icp-color-base ps-2">USD - U.S. Dollar</span>
                  </a>
                  <a href="#" class="icp-button text-decoration-none">
                    <span class="icp-currency-symbol">$</span>
                    <span class="icp-color-base ps-2">United States</span>
                  </a>
                </div>
              </span>
            </div>
